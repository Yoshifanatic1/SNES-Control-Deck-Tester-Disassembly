...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SCDT_InsertIntegratedPatches and SCDT_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SCDT_InsertIntegratedPatches()
...
macro SCDT_ApplyPatchesPostAssembly()
...
macro SCDT_HandleDefaultPatches()
...
org $00FFC0
	...
	db $00,$00,$40,$00,$00,$00,$60,$00,$00,$00,$00,$01
endmacro
